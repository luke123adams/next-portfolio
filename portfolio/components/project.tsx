...
export default function Project ({
    ...
    sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 hover:cursor-pointer transition group:even:pl-8 dark:bg-white/10 dark:hover:bg-white/20'>
        <div className='py-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full group-even:ml-[18rem]'>
        <h3 className="text-2xl font-semibold">{title}</h3>
    <p className='mt-2 leading-relaxed text-gray-700 dark:text-white dark:opacity/70'>{description}</p>
